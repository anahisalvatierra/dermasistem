...
export class Wait {
     ...
     */
    static minimumTimeout = Duration.ofMilliseconds(250);
    /**
     ...
     * @type {Duration}
     */
    static defaultPollingInterval = Duration.ofMilliseconds(500);
    /**
     ...
     */
    static minimumPollingInterval = Duration.ofMilliseconds(50);
    /**
 ...
 * @group Time
 */
export class WaitUntil extends Interaction {
    actual;
    expectation;
    pollingInterval;
    timeout;
