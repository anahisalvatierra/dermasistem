...
export class NotepadAdapter {
    ...
    toJSON() {
        return Question.about('notepad serialised to JSON', async (actor) => {
            return TakeNotes.as(actor).notepad.toJSON();
        });
    }
    /**
     * @inheritDoc
 ...
 * @package
 */
class ChainableNoteSetter extends Interaction {
    notes;
    constructor(notes) {
...
class DescriptionOfNotes extends Question {
    notes;
    options;
...
class NumberOfNotes extends Question {
    constructor() {
        super('notes');
    }
    async answeredBy(actor) {
