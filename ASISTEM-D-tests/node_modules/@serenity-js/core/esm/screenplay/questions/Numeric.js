import { ensure, isNumber, isString } from 'tiny-types';
...
export class Numeric {
     ...
     */
    static sum(...values) {
        return Question.about(the `the sum of ${values}`, async (actor) => {
    ...
    static difference(minuend, subtrahend) {
        return Question.about(the `the difference between ${minuend} and ${subtrahend}`, async (actor) => {
    ...
    static ceiling() {
        return {
            of: (value) => Question.about(the `the ceiling of ${value}`, async (actor) => {
    ...
    static floor() {
        return {
            of: (value) => Question.about(the `the floor of ${value}`, async (actor) => {
                const answer = await actor.answer(value);
     ...
     */
    static max(...values) {
        return Question.about(the `the max of ${values}`, async (actor) => {
            const numbers = await actor.answer(this.flatten(values, isNumber()));
     ...
     */
    static min(...values) {
        return Question.about(the `the min of ${values}`, async (actor) => {
            const numbers = await actor.answer(this.flatten(values, isNumber()));
    ...
    static intValue(base) {
        return {
             ...
             */
            of: (value) => Question.about(the `the integer value of ${value}`, async (actor) => {
    ...
    static bigIntValue() {
        return {
             ...
             *  The value to parse, coerced to a string. Leading whitespace in this argument is ignored.
             */
            of: (value) => Question.about(the `the bigint value of ${value}`, async (actor) => {
                const description = this.descriptionOf(value);
                const stringValue = ensure(description, await actor.answer(value), isString());
                try {
    ...
    static floatValue() {
        return {
             ...
             *  The value to parse, coerced to a string. Leading whitespace in this argument is ignored.
             */
            of: (value) => Question.about(the `the float value of ${value}`, async (actor) => {
                const description = this.descriptionOf(value);
