 ...
 * @param parameters
 */
export function q(templates, ...parameters) {
...
function createParameterValueToDescriptionMapper(options) {
    return async (actor, parameter) => parameter instanceof Describable
...
function templateToQuestion(templates, parameters, descriptionMapper, valueMapper) {
    ...
    }, (context) => templateToQuestion(templates, parameters.map(parameter => Question.isAMetaQuestion(parameter)
