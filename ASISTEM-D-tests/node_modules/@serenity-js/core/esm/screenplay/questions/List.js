...
export class List extends Question {
    ...
    static of(collection) {
        if (Question.isAMetaQuestion(collection)) {
 ...
 * @group Questions
 */
export class MetaList extends List {
    collection;
    constructor(collection) {
        super(collection);
        this.collection = collection;
    ...
    of(context) {
        return new MetaList(this.collection.of(context)).describedAs(this.toString() + d ` of ${context}`);
    }
    eachMappedTo(question) {
 ...
 * @package
 */
class EachMappedTo extends Question {
    collection;
    mapping;
 ...
 * @package
 */
class ForEachLoop extends Task {
    collection;
    subject;
    fn;
