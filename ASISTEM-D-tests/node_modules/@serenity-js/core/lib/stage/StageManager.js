...
class WIP {
    ...
    recordIfAsync(event) {
        if (event instanceof index_js_1.AsyncOperationAttempted) {
        ...
        if (event instanceof index_js_1.AsyncOperationCompleted) {
            this.delete(event.correlationId);
        }
        if (event instanceof index_js_1.AsyncOperationFailed) {
