...
class Stage {
    ...
    configure(options) {
        ...
        if (options.diffFormatter) {
            this.errors = new index_js_1.ErrorFactory(options.diffFormatter);
        }
    }
    /**
    ...
    assignNewActivityId(activityDetails) {
        this.currentActivity = {
            id: index_js_3.CorrelationId.create(),
    ...
    currentActivityId() {
        if (!this.currentActivity) {
            throw new index_js_1.LogicError(`No activity is being performed. Did you call assignNewActivityId before invoking currentActivityId?`);
        }
        return this.currentActivity.id;
    }
    /**
