 ...
 */
class Activity extends Describable_js_1.Describable {
    static errorStackParser = new index_js_1.ErrorStackParser();
    #location;
    ...
    static callerLocation(frameOffset) {
        ...
        return new index_js_2.FileSystemLocation(index_js_2.Path.from(invocationFrame.fileName?.replace(/^file:/, '')), invocationFrame.lineNumber, invocationFrame.columnNumber);
    }
}
