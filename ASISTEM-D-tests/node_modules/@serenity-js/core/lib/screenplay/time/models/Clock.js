...
class Clock {
    checkTime;
    static resolution = Duration_js_1.Duration.ofMilliseconds(10);
    timeAdjustment = Duration_js_1.Duration.ofMilliseconds(0);
     ...
     */
    now() {
        return new Timestamp_js_1.Timestamp(this.checkTime()).plus(this.timeAdjustment);
    }
    /**
