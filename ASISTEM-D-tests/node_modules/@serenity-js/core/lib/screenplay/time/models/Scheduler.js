...
class ScheduledOperation {
    ...
    async poll() {
        ...
        if (this.isCancelled) {
            throw new index_js_1.OperationInterruptedError('Scheduler stopped before executing callback');
        }
    ...
    async invoke() {
        ...
        try {
            if (timeoutExpired) {
                throw new index_js_1.TimeoutExpiredError(`Timeout of ${this.limits.timeout} has expired`);
            }
...
function noDelay() {
    return Duration_js_1.Duration.ofMilliseconds(0);
}
