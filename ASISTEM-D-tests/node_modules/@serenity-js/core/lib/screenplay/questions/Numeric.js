...
const tag_functions_js_1 = require("./tag-functions.js");
/**
...
class Numeric {
     ...
     */
    static sum(...values) {
        return Question_js_1.Question.about((0, tag_functions_js_1.the) `the sum of ${values}`, async (actor) => {
    ...
    static difference(minuend, subtrahend) {
        return Question_js_1.Question.about((0, tag_functions_js_1.the) `the difference between ${minuend} and ${subtrahend}`, async (actor) => {
    ...
    static ceiling() {
        return {
            of: (value) => Question_js_1.Question.about((0, tag_functions_js_1.the) `the ceiling of ${value}`, async (actor) => {
    ...
    static floor() {
        return {
            of: (value) => Question_js_1.Question.about((0, tag_functions_js_1.the) `the floor of ${value}`, async (actor) => {
                const answer = await actor.answer(value);
     ...
     */
    static max(...values) {
        return Question_js_1.Question.about((0, tag_functions_js_1.the) `the max of ${values}`, async (actor) => {
            const numbers = await actor.answer(this.flatten(values, (0, tiny_types_1.isNumber)()));
     ...
     */
    static min(...values) {
        return Question_js_1.Question.about((0, tag_functions_js_1.the) `the min of ${values}`, async (actor) => {
            const numbers = await actor.answer(this.flatten(values, (0, tiny_types_1.isNumber)()));
    ...
    static intValue(base) {
        return {
             ...
             */
            of: (value) => Question_js_1.Question.about((0, tag_functions_js_1.the) `the integer value of ${value}`, async (actor) => {
    ...
    static bigIntValue() {
        return {
             ...
             *  The value to parse, coerced to a string. Leading whitespace in this argument is ignored.
             */
            of: (value) => Question_js_1.Question.about((0, tag_functions_js_1.the) `the bigint value of ${value}`, async (actor) => {
                const description = this.descriptionOf(value);
                const stringValue = (0, tiny_types_1.ensure)(description, await actor.answer(value), (0, tiny_types_1.isString)());
                try {
    ...
    static floatValue() {
        return {
             ...
             *  The value to parse, coerced to a string. Leading whitespace in this argument is ignored.
             */
            of: (value) => Question_js_1.Question.about((0, tag_functions_js_1.the) `the float value of ${value}`, async (actor) => {
                const description = this.descriptionOf(value);
    ...
    static flatten(items, ...predicates) {
        return Question_js_1.Question.about('flatten', async (actor) => {
            const result = [];
    ...
    static descriptionOf(value) {
        ...
        return Question_js_1.Question.formattedValue().of(value).toString();
    }
}
