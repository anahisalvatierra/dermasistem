...
const stringified_js_1 = require("../../io/stringified.js");
 ...
 * @group Activities
 */
class Debug extends Interaction_js_1.Interaction {
    debuggerFunction;
    values;
    /**
    ...
    async performAs(actor) {
        ...
        for (const value of this.values) {
            const result = {
                description: (0, index_js_2.d) `${value}`,
                value: undefined,
                error: undefined,
            };
            try {
            ...
            actor.collect(index_js_3.LogEntry.fromJSON({
                data: JSON.stringify({
                    value: (0, stringified_js_1.stringified)(result.value),
                    error: result.error
                        ? index_js_1.ErrorSerialiser.serialise(result.error)
                        : result.error
                }),
            }), new index_js_3.Name(result.description));
            results.push(result);
        }
