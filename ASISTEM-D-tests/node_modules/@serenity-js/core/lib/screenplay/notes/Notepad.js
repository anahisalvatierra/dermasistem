...
const NotepadAdapter_js_1 = require("./NotepadAdapter.js");
/**
...
class Notepad extends tiny_types_1.TinyType {
     ...
     */
    static notes() {
        return new NotepadAdapter_js_1.NotepadAdapter();
    }
    /**
    ...
    get(subject) {
        if (!this.has(subject)) {
            throw new index_js_1.LogicError((0, index_js_2.d) `Note of ${subject} cannot be retrieved because it's never been recorded`);
        }
