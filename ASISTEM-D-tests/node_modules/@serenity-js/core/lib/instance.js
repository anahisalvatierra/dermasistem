...
const index_js_1 = require("./screenplay/index.js");
...
function getOrCreateSerenity() {
    const globalRegistry = globalThis;
    if (!globalRegistry[SERENITY_INSTANCE_KEY]) {
        const clock = new index_js_1.Clock();
        globalRegistry[SERENITY_INSTANCE_KEY] = new Serenity_js_1.Serenity(clock);
    }
 ...
 * @group Serenity
 */
exports.serenity = getOrCreateSerenity();
/**
