 ...
 * @group Events
 */
class ActorStageExitStarts extends DomainEvent_js_1.DomainEvent {
    sceneId;
    actor;
    static fromJSON(o) {
        return new ActorStageExitStarts(index_js_1.CorrelationId.fromJSON(o.sceneId), o.actor, index_js_2.Timestamp.fromJSON(o.timestamp));
    }
