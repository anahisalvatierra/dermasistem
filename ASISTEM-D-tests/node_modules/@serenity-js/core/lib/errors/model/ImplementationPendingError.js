...
const ErrorSerialiser_js_1 = require("../ErrorSerialiser.js");
const RuntimeError_js_1 = require("./RuntimeError.js");
/**
 ...
 * @group Errors
 */
class ImplementationPendingError extends RuntimeError_js_1.RuntimeError {
    static fromJSON(serialised) {
        const error = new ImplementationPendingError(serialised.message, ErrorSerialiser_js_1.ErrorSerialiser.deserialise(serialised.cause));
