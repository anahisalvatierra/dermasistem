 ...
 * @group Errors
 */
class TestCompromisedError extends RuntimeError_js_1.RuntimeError {
    static fromJSON(serialised) {
        const error = new TestCompromisedError(serialised.message, ErrorSerialiser_js_1.ErrorSerialiser.deserialise(serialised.cause));
