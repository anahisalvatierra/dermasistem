...
class ChangeApiConfigSetUrl extends core_1.Interaction {
    ...
    performAs(actor) {
        return actor.answer(this.newApiUrl)
            .then(newApiUrl => index_js_1.CallAnApi.as(actor).modifyConfig(config => config.baseURL = newApiUrl));
    }
}
/**
 * @package
...
class ChangeApiConfigSetPort extends core_1.Interaction {
    ...
    performAs(actor) {
        return actor.answer(this.newPort)
            .then(newPort => index_js_1.CallAnApi.as(actor).modifyConfig(config => {
            if (!config.baseURL) {
...
class ChangeApiConfigSetHeader extends core_1.Interaction {
    ...
    performAs(actor) {
        return Promise.all([
            ...
            return index_js_1.CallAnApi.as(actor).modifyConfig(config => {
