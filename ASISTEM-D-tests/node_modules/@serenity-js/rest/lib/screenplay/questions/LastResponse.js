...
class LastResponse {
    ...
    static status() {
        return core_1.Question.about(`the status of the last response`, async (actor) => {
            return index_js_1.CallAnApi.as(actor).mapLastResponse(response => response.status);
        });
    }
    /**
    ...
    static body() {
        return core_1.Question.about(`the body of the last response`, async (actor) => {
            return index_js_1.CallAnApi.as(actor).mapLastResponse(response => response.data);
        });
    }
    /**
    ...
    static header(name) {
        return core_1.Question.about(`the '${name}' header of the last response`, async (actor) => {
            return index_js_1.CallAnApi.as(actor).mapLastResponse(response => response.headers[name]);
        });
    }
    /**
    ...
    static headers() {
        return core_1.Question.about(`the headers or the last response`, async (actor) => {
            return index_js_1.CallAnApi.as(actor).mapLastResponse(response => response.headers);
        });
    }
}
