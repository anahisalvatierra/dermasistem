...
import type { ActivityRelatedArtifactArchived, ActivityRelatedArtifactGenerated, ActorEntersStage, ActorSpotlighted, ActorStageExitStarts, BusinessRuleDetected, FeatureNarrativeDetected, SceneBackgroundDetected, SceneDescriptionDetected, SceneTagged, TestRunnerDetected } from '@serenity-js/core/events';
...
export declare abstract class EventQueueProcessor {
    ...
    protected onActorSpotlighted<Context extends SerenityBDDReportContext>(report: Context): (event: ActorSpotlighted) => Context;
