...
const objects_1 = require("tiny-types/objects");
...
function tagOf(tag) {
    return (context) => (0, tiny_types_1.match)(tag)
        ...
        .when(model_1.ProjectTag, (projectTag) => {
        (0, reportIdIncluding_1.reportIdIncluding)(projectTag.name)(context);
        context.report.title = `${context.report.name} - ${(0, mappers_1.escapeHtml)(projectTag.name)}`;
