...
class DownloadArtifact extends core_1.Task {
     ...
     */
    performAs(actor) {
        const tempFileName = new io_1.Path(`${this.gav.toPath().value}.download`), pathToTempFile = this.destinationDirectory.join(tempFileName), // eslint-disable-line unicorn/prevent-abbreviations
