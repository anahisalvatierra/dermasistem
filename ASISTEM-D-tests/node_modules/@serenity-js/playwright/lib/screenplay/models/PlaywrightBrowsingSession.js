...
const PlaywrightCookie_js_1 = require("./PlaywrightCookie.js");
...
class PlaywrightBrowsingSession extends web_1.BrowsingSession {
    ...
    selectors;
    serenitySelectorEngines = new index_js_1.SerenitySelectorEngines();
    ...
    async cookie(name) {
        ...
        return new PlaywrightCookie_js_1.PlaywrightCookie(context, name);
    }
    ...
    async browserContext() {
        if (!this.currentPlaywrightBrowserContext) {
            ...
            this.currentPlaywrightBrowserContext.on('page', async (page) => {
                const playwrightPage = new PlaywrightPage_js_1.PlaywrightPage(this, page, this.extraBrowserContextOptions, model_1.CorrelationId.create());
