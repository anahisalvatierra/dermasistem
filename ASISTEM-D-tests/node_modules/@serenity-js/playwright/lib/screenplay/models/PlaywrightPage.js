...
const scripts = __importStar(require("@serenity-js/web/scripts"));
const promised_js_1 = require("../promised.js");
const index_js_1 = require("./locators/index.js");
const PlaywrightModalDialogHandler_js_1 = require("./PlaywrightModalDialogHandler.js");
...
class PlaywrightPage extends web_1.Page {
    ...
    constructor(session, page, options, pageId) {
        super(session, new index_js_1.PlaywrightRootLocator(page), new PlaywrightModalDialogHandler_js_1.PlaywrightModalDialogHandler(page), pageId);
        this.page = page;
        this.options = options;
    }
    createPageElement(nativeElement) {
        return new PlaywrightPageElement_js_1.PlaywrightPageElement(new index_js_1.PlaywrightExistingElementLocator(this.rootLocator, new web_1.ByDeepCss(nativeElement._selector), nativeElement));
    }
    locate(selector) {
        return new PlaywrightPageElement_js_1.PlaywrightPageElement(new index_js_1.PlaywrightLocator(this.rootLocator, selector));
    }
    locateAll(selector) {
        return core_1.List.of(new web_1.PageElementsLocator(new index_js_1.PlaywrightLocator(this.rootLocator, selector)));
    }
    ...
    isPresent() {
        return (0, promised_js_1.promised)(!this.page.isClosed());
    }
    async nativePage() {
        return (0, promised_js_1.promised)(this.page);
    }
    async resetState() {
