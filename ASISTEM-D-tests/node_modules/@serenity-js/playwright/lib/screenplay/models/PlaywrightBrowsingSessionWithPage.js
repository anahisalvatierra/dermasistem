 ...
 *  @group Models
 */
class PlaywrightBrowsingSessionWithPage extends PlaywrightBrowsingSession_js_1.PlaywrightBrowsingSession {
    page;
    ...
    async registerCurrentPage() {
        ...
        const playwrightPage = new PlaywrightPage_js_1.PlaywrightPage(this, this.page, this.extraBrowserContextOptions, this.playwrightManagedPageId);
