...
class BrowseTheWebWithPlaywright extends web_1.BrowseTheWeb {
    static using(browser, browserContextOptions, extraBrowserContextOptions) {
        return new BrowseTheWebWithPlaywright(new index_js_1.PlaywrightBrowsingSessionWithBrowser(browser, browserContextOptions, extraBrowserContextOptions, playwright.selectors));
    }
