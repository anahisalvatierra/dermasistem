...
const io_2 = require("@serenity-js/core/io");
const model_1 = require("@serenity-js/core/model");
const TestStepFormatter_js_1 = require("./TestStepFormatter.js");
/**
 * @package
 */
class CucumberMessagesParser {
    ...
    formatterHelpers;
    shouldReportStep;
    testStepFormatter = new TestStepFormatter_js_1.TestStepFormatter();
    currentScenario;
