...
const CucumberMessagesParser_js_1 = require("./parser/CucumberMessagesParser.js");
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
function default_1(serenity, moduleLoader) {
    ...
    return class CucumberMessagesListener extends Formatter {
        ...
        constructor(options) {
            super(options);
            this.parser = new CucumberMessagesParser_js_1.CucumberMessagesParser(serenity, formatterHelpers, options, (step) => step?.actionLocation?.uri !== CucumberMessagesListener.fakeInternalAfterHookUri);
            this.supportCodeLibrary = this.supportCodeLibrary ?? options.supportCodeLibrary;
            this.addAfterHook(() => {
                this.emit(new events_1.SceneFinishes(serenity.currentSceneId(), new model_1.ExecutionSuccessful(), serenity.currentTime()));
