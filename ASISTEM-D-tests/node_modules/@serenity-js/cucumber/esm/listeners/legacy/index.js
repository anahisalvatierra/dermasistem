 ...
 * @param moduleLoader
 */
export function createListener(serenity, moduleLoader) {
    const version = moduleLoader.versionOf('cucumber');
    try {
        const cucumber = moduleLoader.require('cucumber'), notifier = new Notifier(serenity), mapper = new FeatureFileMapper(), resultMapper = new ResultMapper(serenity), cache = new Cache(), loader = new FeatureFileLoader(new FeatureFileParser(new GherkinParserAdapter()), mapper, cache);
