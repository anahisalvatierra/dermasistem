...
const PageElementInteraction_js_1 = require("./PageElementInteraction.js");
/**
 ...
 * @group Activities
 */
class Press extends PageElementInteraction_js_1.PageElementInteraction {
    keys;
    /**
    ...
    async performAs(actor) {
        ...
        const page = await index_js_1.BrowseTheWeb.as(actor).currentPage();
        return page.sendKeys(keys);
    }
}
exports.Press = Press;
class PressKeyInField extends PageElementInteraction_js_1.PageElementInteraction {
    keys;
    field;
    /**
...
class KeySequence extends core_1.Question {
    ...
    static describe(keys) {
        ...
        const description = keys.reduce((acc, key, index) => {
            const separator = index_js_2.Key.isKey(key) && key.isModifier
                ? '-'
                : acc.separator;
            return {
                description: index === 0
