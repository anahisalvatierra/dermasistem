...
const index_js_2 = require("../abilities/index.js");
/**
...
class Cookie {
    ...
    static called(name) {
        return core_1.Question.about(`"${name}" cookie`, async (actor) => {
            ...
            const page = await index_js_2.BrowseTheWeb.as(actor).currentPage();
    ...
    static set(cookieData) {
        return core_1.Interaction.where((0, core_1.the) `#actor sets cookie: ${cookieData}`, async (actor) => {
    ...
    async isPresent() {
        try {
            ...
            if (error instanceof index_js_1.CookieMissingError) {
                return false;
            }
            throw error;
        }
