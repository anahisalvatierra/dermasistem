...
const PageElementsLocator_js_1 = require("./PageElementsLocator.js");
/**
...
class PageElements extends core_1.MetaList {
    static located(selector) {
        return new PageElements(PageElementsLocator_js_1.PageElementsLocator.fromDocumentRoot(selector));
    }
}
