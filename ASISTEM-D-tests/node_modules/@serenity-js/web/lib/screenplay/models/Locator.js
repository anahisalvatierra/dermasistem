...
const RootLocator_js_1 = require("./RootLocator.js");
const index_js_1 = require("./selectors/index.js");
/**
 ...
 * @group Models
 */
class Locator extends RootLocator_js_1.RootLocator {
    parent;
    selector;
    ...
    asCssSelector(selector) {
        if (selector instanceof index_js_1.ByCss) {
            return selector;
        }
        if (selector instanceof index_js_1.ById) {
            return new index_js_1.ByCss(`#${selector.value}`);
        }
        if (selector instanceof index_js_1.ByTagName) {
            return new index_js_1.ByCss(`${selector.value}`);
        }
