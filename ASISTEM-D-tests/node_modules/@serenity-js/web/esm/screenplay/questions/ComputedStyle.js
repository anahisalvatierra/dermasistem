 ...
 * @group Questions
 */
export class ComputedStyle extends Question {
    name;
    element;
    pseudoElement;
    /**
    ...
    ofPseudoElement(pseudoElement) {
        return Question.createAdapter(new ComputedStyle(this.name, this.element, pseudoElement));
    }
    /**
     ...
     */
    of(pageElement) {
        return Question.createAdapter(new ComputedStyle(this.name, this.element
