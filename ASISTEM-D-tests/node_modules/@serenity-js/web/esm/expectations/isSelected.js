...
const isElementSelected = Expectation.define('isSelected', 'become selected', (actual) => actual.isSelected());
/**
...
export function isSelected() {
    return Expectation.to('become selected').soThatActual(and(isPresent(), isElementSelected()));
}
