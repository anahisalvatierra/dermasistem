...
const isElementVisible = Expectation.define('isVisible', 'become visible', (actual) => actual.isVisible());
/**
...
export function isVisible() {
    return Expectation.to('become visible').soThatActual(and(isPresent(), isElementVisible()));
}
