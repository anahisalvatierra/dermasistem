...
const isElementEnabled = Expectation.define('isEnabled', 'become enabled', (actual) => actual.isEnabled());
/**
...
export function isEnabled() {
    return Expectation.to('become enabled').soThatActual(and(isPresent(), isElementEnabled()));
}
