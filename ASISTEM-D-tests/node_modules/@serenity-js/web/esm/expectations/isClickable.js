...
const isElementClickable = Expectation.define('isClickable', 'become clickable', (actual) => actual.isClickable());
/**
...
export function isClickable() {
    return Expectation.to('become clickable').soThatActual(and(isPresent(), isElementClickable()));
}
