...
const isElementActive = Expectation.define('isActive', 'become active', (actual) => actual.isActive());
/**
...
export function isActive() {
    return Expectation.to('become active').soThatActual(and(isPresent(), isElementActive()));
}
