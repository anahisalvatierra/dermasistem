...
export function isInstanceOf(type) {
    return Predicate.to(`be instance of ${type.name}`, (value) => {
        ...
        if (isTinyTypeSubclass(type) && isTinyType(value)) {
            ...
            return isTinyTypeOf(value, type);
        }
 ...
 */
function isTinyTypeSubclass(type) {
