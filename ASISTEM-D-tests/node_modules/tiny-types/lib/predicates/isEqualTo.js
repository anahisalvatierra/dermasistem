...
function isEqualTo(expectedValue) {
    return Predicate_js_1.Predicate.to(`be equal to ${String(expectedValue)}`, (value) => (hasEquals(value) && hasEquals(expectedValue))
        ? value.equals(expectedValue)
        : value === expectedValue);
}
function hasEquals(value) {
    return !!value && (value instanceof TinyType_js_1.TinyType || value.equals);
}
