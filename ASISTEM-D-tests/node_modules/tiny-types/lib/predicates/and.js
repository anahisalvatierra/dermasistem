...
const isGreaterThan_js_1 = require("./isGreaterThan.js");
...
/** @access private */
class And extends Predicate_js_1.Predicate {
    predicates;
    constructor(predicates) {
        super();
        this.predicates = predicates;
        const results = [
            _ => (0, isDefined_js_1.isDefined)().check(_),
            _ => (0, isArray_js_1.isArray)().check(_),
            _ => (0, isGreaterThan_js_1.isGreaterThan)(0).check(_.length),
        ];
        if (results.some(check => check(this.predicates) instanceof Predicate_js_1.Failure)) {
    ...
    check(value) {
        for (const predicate of this.predicates) {
            ...
            if (result instanceof Predicate_js_1.Failure) {
                return result;
            }
        }
        return new Predicate_js_1.Success(value);
    }
}
