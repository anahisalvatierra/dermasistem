...
exports.isTinyType = isTinyType;
exports.isTinyTypeOf = isTinyTypeOf;
exports.TinyTypeOf = TinyTypeOf;
const ensure_js_1 = require("./ensure.js");
const index_js_1 = require("./objects/index.js");
const index_js_2 = require("./predicates/index.js");
/**
 ...
 */
function isTinyType(value) {
    return value !== null &&
        typeof value === 'object' &&
        value[TINY_TYPE_BRAND] === true;
}
/**
 ...
 */
function isTinyTypeOf(value, type) {
...
function TinyTypeOf() {
    return class extends TinyType {
        ...
        constructor(value) {
            super();
            this.value = value;
            (0, ensure_js_1.ensure)(this.constructor.name, value, (0, index_js_2.isDefined)());
        }
    };
}
/**
...
class TinyType {
     ...
     */
    equals(another) {
        return (0, index_js_1.equal)(this, another);
    }
    /**
     ...
     */
    toString() {
        return (0, index_js_1.stringify)(this);
    }
    /**
     ...
     */
    toJSON() {
        const fields = (0, index_js_1.significantFieldsOf)(this);
        if (fields.length === 1) {
            return (0, index_js_1.toJSON)(this[fields[0]]);
        }
        return fields.reduce((acc, field) => {
            acc[field] = (0, index_js_1.toJSON)(this[field]);
            return acc;
        }, {});
    }
}
